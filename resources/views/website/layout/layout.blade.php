...
<body>
        ...
        <div class="row align-items-center bg-light px-lg-5">
            <div class="col-12 col-md-8">
                <div class="d-flex justify-content-between">
                    <div class="bg-primary text-white text-center py-2" style="width: 100px;border-bottom-left-radius: 50%;border-bottom-right-radius: 50%;">Tranding</div>
        ...
        <div class="row align-items-center py-2 px-lg-5">
            <div class="col-lg-4">
                <a href="{{route('index')}}" class="navbar-brand d-none d-lg-block">
                    <img src="{{ asset($setting->logo) }}" alt="{{ asset($setting->title) }}" style="height: 50px;">
                </a>
            </div>
            {{-- <div class="col-lg-8 text-center text-lg-right">
                <img class="img-fluid" src="{{ asset($setting->logo) }}" alt="" style="height: 30px">
            </div> --}}
        </div>
    </div>
    <!-- Topbar End -->
    ...
    <div class="container-fluid p-0 mb-3">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            <a href="" class="navbar-brand d-block d-lg-none">
                <img src="{{ asset($setting->logo) }}" alt="{{ asset($setting->title) }}" style="height: 40px;">
            </a>
            <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0" style="border-radius: 5px">
                    ...
                    <div class="nav-item dropdown">
                        <a   href="{{ route('send.email') }}" class="nav-link">{{ __('words.contact') }}</a>
                    </div>
                ...
                {{-- <div class="nav-item dropdown">
                    <a href="{{ route('contact') }}" class="dropdown-item">Contant</a>
                </div> --}}



                <li class="nav-link active nav-item dropdown" style="padding-left:0 ">
                    <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button"
                        aria-haspopup="true" aria-expanded="false">
                        <span class="hidden-md-down">{{ LaravelLocalization::getCurrentLocaleNative() }}</span>
                    </a>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center">
            ...
            by <a class="font-weight-bold" href="#">Mohamed Algendy</a>
        </p>
    </div>
    <!-- Footer End -->
